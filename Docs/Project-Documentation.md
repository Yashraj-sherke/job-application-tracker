...
When I started applying for jobs on different platforms, I quickly realized that the real challenge was not only getting interviews — it was remembering everything without losing my mind.

I had to keep track of:
- where I applied (was it TechCorp or CorpTech?),
- which version of my resume I sent (v4_FINAL_final_really.pdf),
- recruiter messages,
- deadlines,
- interview rounds,
- and follow-ups I promised myself I would never forget... but somehow always did.

At first, I thought, “No problem, I will just make an Excel sheet.”

That idea lasted exactly until I realized I would have to manually add every single row, update every status, and remember every deadline by myself. Excel became less of an elegant solution and more of an unpaid part-time job.

Then I thought about using Notion. It was cleaner, more organized, and honestly very tempting.

But after a while, one thought kept coming back to me:

**I am a software engineer. Why am I still depending on tools that I can build for myself?** (And more importantly, why am I avoiding building another side project?)

That is when this project was born — a **Job Application Tracker** designed to solve the exact problem I was facing.

Instead of juggling spreadsheets, sticky notes, 47 open browser tabs, and mental stress, I built a web app where I can:
- track every job application in one place,
- move applications through different stages,
- store recruiter interactions,
- remember deadlines,
- and stay organized without pretending my memory is stronger than a goldfish's.

This project is not just a tracker.  
It is my personal answer to chaos.

And honestly, it feels much better to build the system than to keep apologizing to myself for forgetting follow-ups!
